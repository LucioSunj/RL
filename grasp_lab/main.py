...
if __name__ == '__main__':
    ...
    time0 = 1
    q0 = robot.get_joint()
    # q1 = np.array([0.0, 0.0, np.pi / 2, 0.0, -np.pi / 2, 0.0, 0.0])
    q1 = np.array([0.0, -np.pi/4, 0.0, -3*np.pi/4, 0.0, np.pi/2, np.pi/4])
    ...
    # time_array = [0, time0, time1]
    # planner_array = [planner0, planner1]
